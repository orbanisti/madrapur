                  ...
                  <div>
                      ...
                      <div className="option-group">
                          <div className="option-container" >
                              <input value="1" onChange={this.handleChange}  className="option-input" id="option-1" type="radio" name="options" />
                              <input value="3" onChange={this.handleChange}  className="option-input" id="option-2" type="radio" name="options" />
