...
backend\assets\BootstrapstarratingAsset::register($this);

?>

<div class="col-sm-6 col-md-4 col-lg-3 col-margin product-list-view">
    <div class="col-item">
                ...
                <div class="rating hidden-sm col-md-6">
                    <script>
                        jQuery(document).ready(function () {
                            $("#rating-average-<?= $model->id ?>").rating({
                                min:0,
                                max:5,
                                step:0.1,
                                size:'sm',
                    ...
                    <input class="hide" id="rating-average-<?= $model->id ?>" type="number" value="<?= round($model->opinionsaverage,1) ?>" class="rating" data-rtl="false">
