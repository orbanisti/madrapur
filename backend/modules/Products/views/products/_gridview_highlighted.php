                ...
                <div class="rating hidden-sm col-md-6">
                    <script>
                        jQuery(document).ready(function () {
                            $("#rating-averageh-<?= $model->id ?>").rating({
                                min:0,
                                max:5,
                                step:0.1,
                                size:'sm',
                    ...
                    <input class="hide" id="rating-averageh-<?= $model->id ?>" type="number" value="<?= round($model->opinionsaverage,1) ?>" class="rating" data-rtl="false">
