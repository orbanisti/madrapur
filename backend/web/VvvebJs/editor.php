...
<html lang="en">
  <head>
    ...
    <title>VvvebJs</title>
      ...
      <?php $this->registerCssFile('VvvebJs/css/editor.css', ['depends' => [yii\bootstrap\BootstrapAsset::className()]]); ?>
      <?php $this->registerCssFile('VvvebJs/css/line-awesome.css', ['depends' => [yii\bootstrap\BootstrapAsset::className()]]); ?>
  </head>
<body>
...
<?php $this->registerJsFile('VvvebJs/js/jquery.hotkeys.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?>

<!-- bootstrap-->
<?php $this->registerJsFile('VvvebJs/js/popper.min.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?>
<?php $this->registerJsFile('VvvebJs/js/bootstrap.min.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?>

<!-- builder code-->
<?php $this->registerJsFile('VvvebJs/libs/builder/builder.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?>
<!-- undo manager-->
<?php $this->registerJsFile('VvvebJs/libs/builder/undo.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?>
<!-- inputs-->
<?php $this->registerJsFile('VvvebJs/libs/builder/inputs.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?>

<!-- bootstrap colorpicker //uncomment bellow scripts to enable -->
<!--
<?php $this->registerJsFile('VvvebJs/libs/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?>
<link href="libs/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css" rel="stylesheet">
<?php $this->registerJsFile('VvvebJs/libs/builder/plugin-bootstrap-colorpicker.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?>
-->
...
<!-- blocks-->
<?php $this->registerJsFile('VvvebJs/libs/builder/blocks-bootstrap4.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?>

<!-- plugins -->

<!-- code mirror - code editor syntax highlight -->

<?php $this->registerCssFile('VvvebJs/libs/codemirror/lib/codemirror.css', ['depends' => [yii\bootstrap\BootstrapAsset::className()]]); ?>
<?php $this->registerCssFile('VvvebJs/libs/codemirror/theme/material.css', ['depends' => [yii\bootstrap\BootstrapAsset::className()]]); ?>


<?php $this->registerJsFile('VvvebJs/libs/codemirror/lib/codemirror.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?>
<?php $this->registerJsFile('VvvebJs/libs/codemirror/lib/xml.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?>
<?php $this->registerJsFile('VvvebJs/libs/codemirror/lib/formatting.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?>
<?php $this->registerJsFile('VvvebJs/libs/builder/plugin-codemirror.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?>
