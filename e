...
[31m-[m
[31m-    <p>[m
[31m-        <?= Html::a(Yii::t('app', 'Új időpont tiltás'), ['create'], ['class' => 'btn btn-success']) ?>[m
[31m-    </p>[m
[31m-[m
[31m-    <?= GridView::widget([[m
...
[32m+[m[41m[m
[32m+[m[32m    <p>[m[41m[m
[32m+[m[32m        <?= Html::a(Yii::t('app', 'Új időpont tiltás'), ['create'], ['class' => 'btn btn-success']) ?>[m[41m[m
[32m+[m[32m    </p>[m[41m[m
[32m+[m[41m[m
...
[31m-        <?= Html::submitButton($model->isNewRecord ? Yii::t('app', 'Mentés') : Yii::t('app', 'Módosítás'), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>[m
[31m-    </div>[m
[31m-[m
